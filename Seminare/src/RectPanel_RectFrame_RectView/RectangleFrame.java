package RectPanel_RectFrame_RectView;
	...
	void setupFrame() {
		...
		btnAddRectangle.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				RectanglePanel.MyRectangle rect = _panelRect.new MyRectangle((int) (Math.random() * 1000),
						(int) (Math.random() * 1000), (int) (Math.min(Math.random() * 1000, 1)),
